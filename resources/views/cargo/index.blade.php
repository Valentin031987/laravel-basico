                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                Cargo
                                <a href="{{ route('cargos.create') }}" class="btn btn-primary float-end btn-sm"><i
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('cargos.index') }}" method="GET" class="row g-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <a href="{{ route('cargos.index') }}"><button type="button"
                                                class="btn btn-secondary btn-sm">Ver Todo</button></a>
                                    </div>
                                </form>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('cargos.destroy', $cargo->id) }}"
                                                            ...
                                                            <a class="btn btn-sm btn-primary "
                                                                href="{{ route('cargos.show', $cargo->id) }}"><i
