...
<div class="col-md-6">
    ...
    <input class="form-control @error('fecha_ultima_modificacion') is-invalid @enderror"
        placeholder="Fecha Ultima Modificacion" name="fecha_ultima_modificacion" type="text"
    ...
    <ul class="nav nav-tabs my-3" id="tab" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button"
                role="tab" aria-controls="home" aria-selected="true">Información General</button>
        </li>
        <li class="nav-item" role="presentation">
        ...
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="correos-tab" data-bs-toggle="tab" data-bs-target="#correos" type="button"
                role="tab" aria-controls="correos" aria-selected="false">Lista de
                correos</button>
        </li>
    </ul>
    ...
    <div class="tab-content px-3" id="tab-content">
        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            ...
            <div class="col-md-6">
                ...
                <select class="form-select @error('cargo_id') is-invalid @enderror" name="cargo_id" id="cargo_id">
                ...
                <tbody>
                    @foreach ($tareas as $key => $d)
                        <tr>
                            ...
                            <td>
                                <button type="button" class="editarTarea btn btn-secondary" data-bs-toggle="modal"
                                    data-bs-target="#editarTarea" 
                                    data-url="{{ route('tareas.update', $d->id) }}"
                                    data-tarea="{{$d->tarea }}"
                                    data-tipo-tarea-id="{{ $d->tipotarea_id }}"
